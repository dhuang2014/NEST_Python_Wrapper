...
class NESTcalc {
 ...
 public:
  ...
  // photo-sensors
  std::vector<double> GetSpike(int Nph, double dx, double dy, double dz, double dt,
  ...
  // provided by GetS1 and does more realistic smearing
	std::vector<double> GetSpikeRun4 (double spike, double dx, double dy, double dz, double dt, 
